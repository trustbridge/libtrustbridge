...
from libtrustbridge.repos.miniorepo import slash_chunk, MinioRepo

MINIOREPO_MODULE = 'libtrustbridge.repos.miniorepo'
...
@mock.patch(f'{MINIOREPO_MODULE}.ClientError', Exception)
